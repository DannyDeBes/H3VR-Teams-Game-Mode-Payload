...
public class TGM_Gamemode
{
    ...
    public virtual void GameOver()
    {
        ...
        //Respawn back to Main area
        GM.CurrentMovementManager.TeleportToPoint(Global.GetValidSpawnPoint(TGM_Scene.instance.playerSpawnPoint),
            true,
            TGM_Scene.instance.playerSpawnPoint.rotation.eulerAngles);
    }
    ...
    public IEnumerator PostGameCountdown()
    {
